                    ...
                    {showData.length > 0 ? <>
                        <div className = "details-top">
                            ...
                            <div className = "details-right card">
                                ...
                                <p><strong>Gain / loss for 100 stocks invested {(showData[0].Historical_Price[0].date.substring(0,4) - showData[0].Historical_Price[1].date.substring(0,4))} years ago: </strong>
